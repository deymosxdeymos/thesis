...
\documentclass[twoside]{report} % Untuk versi perpustakaan
...
\title{Pengembangan Dashboard Pembagian Kelompok Mahasiswa Berbasis \textit{Artificial Intelligence} dengan Metode \textit{Agile Kanban}}
% Judul Tugas Akhir dalam Bahasa Inggris
\titleEN{Development of Student Group Division Dashboard Based on Artificial Intelligence with Agile Kanban Method}
% JUDUL AKAN DITULIS DALAM HURUF KAPITAL; Font size 16 pt; Bold; Tidak melebihi 4 baris

% Informasi Mahasiswa
\author{Galin Nichola Gibran}		% Nama Mahasiswa
\nim{121140050}				% NIM Mahasiswa

%Informasi Dosen Pembimbing
\dosbingA%
{Hafiz Budi Firmansyah}%			% Nama Dosen Pembimbing 1
{NIP. 19910824 201903 1 014}	% NIP Dosen Pembimbing 1
% \dosbingB%
...
\pengujiA%
{Arief Ichwani, S.Kom., M.Cs.}%				% Nama Dosen Penguji 1
{NIP. 19900811 201903 1 011}	% NIP Dosen Penguji 1
\pengujiB%
...
\listoffigures
% Daftar lampiran (commented out - tidak diperlukan)
% \phantomsection%
% \addcontentsline{toc}{chapter}{DAFTAR LAMPIRAN}
% \listofmyappendices
% Daftar rumus (empty, commented out)
...
% Daftar kode (empty, commented out)
% \phantomsection%
...
% Mulai selang-seling halaman - pastikan BAB I dimulai di halaman ganjil (kanan)
% Harus cleardoublepage SEBELUM reset page counter agar cek halaman fisik benar
\cleardoublepage
