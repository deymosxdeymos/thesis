...
\begin{longtable}{| b{0.1\textwidth}|p{0.3\textwidth}|p{0.4\textwidth}|}
	...
	\hline
	F-16          & Dosen                   & \textit{Import} hasil pembagian kelompok                      \\
	\hline
...
\begin{longtable}{| b{0.08\textwidth}|p{0.5\textwidth}|p{0.22\textwidth}|}
	...
	\hline
	22          & Dosen dapat \textit{edit} anggota kelompok (\textit{manual override})            & SEDANG             \\
	\hline
	23          & Melihat persebaran \textit{MBTI} dan \textit{skill} mahasiswa (\textit{diagram}) & RENDAH             \\
	\hline
	24          & Melihat penjelasan \textit{MBTI}                                                 & SEDANG             \\
	\hline
	25          & Pengujian \textit{Grey Box} terhadap fitur utama                                 & TINGGI             \\
	\hline
	26          & \textit{Deployment} aplikasi ke \textit{server}                                  & SEDANG             \\
	\hline
\end{longtable}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{figure/chapter-3/activity/activity-registrasi.pdf}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{figure/chapter-3/erd.pdf}
